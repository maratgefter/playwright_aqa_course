...
test.describe("[Sales Portal] [Products]", () => {
  ...
  test.skip("Search by name", async ({ productsApiService, productsListUIService, productsListPage }) => {
    /*
    login
  ...
  test.skip("Search by price", async ({ productsApiService, productsListUIService, productsListPage }) => {
    token = await productsListPage.getAuthToken();
    const product = await productsApiService.create(token);
    await productsListUIService.open();
  ...
  test.skip("Search by manufacturer", async ({ productsApiService, productsListUIService, productsListPage }) => {
    token = await productsListPage.getAuthToken();
    const product = await productsApiService.create(token);
    await productsListUIService.open();
